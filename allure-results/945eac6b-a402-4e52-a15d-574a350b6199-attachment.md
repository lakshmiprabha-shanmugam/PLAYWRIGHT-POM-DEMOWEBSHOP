...
- Name: checkout.spec.ts >> 4.7 Checkout Flow >> TC-CHK-05: Checkout — shipping same as billing
- Location: tests\checkout.spec.ts:134:7
...
- generic [ref=e2]:
  - generic [ref=e3]:
    - generic [ref=e4]:
      ...
      - list [ref=e10]:
        - listitem [ref=e11]:
          - link "testcheckout+1777172820755@gmail.com" [ref=e12] [cursor=pointer]:
            - /url: /customer/info
        - listitem [ref=e13]:
          ...
          - generic [ref=e54]:
            - generic [ref=e61]:
              ...
              - generic [ref=e68]:
                ...
                - textbox "Email:" [ref=e70]: testcheckout+1777172820755@gmail.com
                - text: "*"
              - generic [ref=e71]:
